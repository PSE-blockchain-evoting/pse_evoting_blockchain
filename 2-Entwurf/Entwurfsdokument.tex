...
\subsection{Interfaces zwischen den Paketen}
	...
	\end{itemize}
	Im GO-Chaincode wird zusätzlich fabrics shim benötigt:
	\begin{itemize}
	...
	Das Paket \textitx{SDKConnection} stellt die Verbindung der Software zum \textitx{Hyperledger Fabric SDK} und \textitx{Hyperledger Fabric CA SDK} dar. Diese SDKs übernehmen ihrerseits die Kommunikation mit dem Netzwerk. Hierdurch wird \textbf{F13} erfüllt. \textitx{SDKConnection} ist Teil des \textitx{Models}.
