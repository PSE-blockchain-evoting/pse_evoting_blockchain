...
\subsection{Typische Abläufe}
	...
	Die Schnittstelle ist in drei Interfaces unterteilt. Eine enthält die Gemeinsamkeiten (\textitx{SDKInterface}) der beiden Klienten und \textitx{SupervisorSDKInterface} und \textitx{VoterSDKInterface} enthalten jeweils die Unterschiede der Wahlleiter- und Wähler- Klienten.
