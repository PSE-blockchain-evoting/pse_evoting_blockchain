...
\begin{document}
	...
	\section{View}
		...
		Die Schnittstellen von Control und Model werden in der Adapter Klasse \textit{SupervisorAdapter} vereinigt. Ein Objekt dieser Klasse wird an alle View Klassen überreicht die auf die Schnittstelle zugreifen müssen. Dies verringert die Anzahl an Objekten die durch alle Konstruktoren gereicht werden müssen und reduziert die Kohäsion zwischen den MVC-Paketen.
