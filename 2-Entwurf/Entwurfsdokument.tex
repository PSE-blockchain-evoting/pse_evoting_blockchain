...
\subsection{Interfaces zwischen den Paketen}
	...
	\end{itemize} 
	\begin{itemize}
	\item\fakeparagraph{ElectionStatusListener} Das ElectionStatusListener Interface bietet dem Model möglichkeiten der GUI den Status der Wahl mitzuteilen. So kann ein Update der Daten in der GUI angefragt werden oder die Beendigung der Wahl mittgeteilt werden.
	...
	Daraufhin wird eine \textit{VoterSDKInterfaceImpl} instanziiert und erhält zwei Parameter: Den Pfad zum Wähler-Zertifikat und einen Listener.
	...
	Bei erfolgreich abgeschlossener Authentifizierung wird durch \textit{showChoice()} auf der \textit{VoterGUI} eine neues \textit{VoterChoice} Panel erstellt und angezeigt, welches die Ansicht ist auf der es dem Wähler möglich ist zu wählen.
