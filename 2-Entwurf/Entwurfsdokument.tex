...
\subsection{Typische Abläufe}
	...
	Dabei kommuniziert es mit dem SDKConnection-Paket um Daten von der Blockchain zu holen und Aktionen auf der Blockchain auszuführen.
		...
		\begin{itemize}
			\item\fakeparagraph{SupervisorElection} Diese Klasse hält eine Assoziation zum \textitx{SupervisorSDKInterface} und jeweils eine Assoziation zu jedem wahlberechtigten Wähler, der durch eine \textit{Voter}-Instanz modelliert wird .
