...
\subsection{Interfaces zwischen den Paketen}
	...
	Dann beginnt die Autorisierung durch Aufruf von authorization() auf einem VoterElection Objekt.
	Der Konstruktor von VoterSDKInterfaceImpl erhält zwei Parameter: Den Pfad zum Wähler-Zertifikat und einen Listener.
	Die Control-Ebene braucht von der View-Ebene den Pfad zum Wähler-Zertifikat.
	Das passiert durch getAuthentication().
	listener ist Attribute von VoterElection.
	Mit der start Methode wird ein neuer Thread erzeugt. 
	Dann wird der Wähler benachrichtigt, dass er erfolgreich authentifiziert wurde.
	Das passiert durch "true" Rückgabe von VoterElection zu ActionListener.
	Dann an der View-Ebene von dem Wähler wurde seine Wahl angezeigt durch
	showChoice Methode zu VoterGUI. 
	Zu diesem Zeitpunkt passiert Panels-Switch von VoterAuthentication zu VoterChoice.
	Dazu wird neue Instanz von VoterChoice-Panel erzuegt.
