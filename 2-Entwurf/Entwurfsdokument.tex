...
\subsection{Interfaces zwischen den Paketen}
	...
	\item\fakeparagraph{Import eine Wahlkonfiguration, \autoref{fig:config_import}} Nach Auslösen des ImportConfigListeners, wird in der View nach dem ausgewählten Pfad gefragt. Dieser Pfad wird an das Model gegeben, welches die Datei liest und dort abgespeicherten Daten in ihren Attributen ablegt.
	...
	Dabei holt die SupervisorGUI die Wahldaten über das ElectionDataIF Data Transfer Objekt und die aus der Konfigurations definierten Wähler. Diese beiden Daten Objekte werden dann einzeln an die ConfigGUI gereicht, welche die im ElectionDataIF enthaltene Daten extrahiert und in den entsprechenden SupervisorGUIPanel Objekten einsetzt.
