...
\subsection{Typische Abläufe}
	...
	Damit der Klient darüber informiert ist, ob die Wahl noch läuft wird der \textitx{SDKEventListener} benutzt. Diesem wird ein Timer mit zufälliger Dauer zugewiesen. Wenn dieser abläuft wird eine Anfrage an das Netzwerk gesendet, ob die Wahl bereits geendet hat. Auf diese Anfrage antwortet das Netzwerk mit einem Event an alle Klienten, welche daraufhin ihre GUI aktualisieren und ihren Timer zurücksetzen. Hierdurch wird die Netzwerklast gering gehalten, da stets nur der Klient, dessen Timer die geringste Laufzeit hat, Netzwerkanfragen sendet und dennoch alle Klienten aktualisiert werden.
