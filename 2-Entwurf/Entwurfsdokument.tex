...
\subsection{Typische Abläufe}
	...
	Damit der Klient darüber informiert ist, ob die Wahl noch läuft wird der \textitx{SDKEventListener} benutzt. 
	Dieser fragt in einem zufällig gewählten Zeitabstand ab, ob die Wahl bereits geendet hat. Auf diese Anfrage antwortet das Netzwerk mit einem Event an alle Klienten, welche daraufhin ihre GUI aktualisieren. Somit wird immer vom Klienten mit dem geringsten Zeitabstand der Status der Wahl abgefragt und somit Netzwerklast gering gehalten.
