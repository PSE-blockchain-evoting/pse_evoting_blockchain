...
Für das modulare Tabellensystem wurde das Dekorierer-Entwurfsmuster benutzt um dynamisch verschiedene GUI-Komponenten in eine Tabelle hinzuzufügen. Der Dekorierer ist in der Klasse ListExtension implementiert und ist speziell dafür zuständig die Zeilen in einer Tabelle zu generieren (sog. Entries). Diese Entries werden dann in der Tabelle vertikal angezeigt.
