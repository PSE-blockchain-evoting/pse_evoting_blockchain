...
\begin{figure}[ht]
	\fbox{\includegraphics[width=\textwidth]{res/voting_sys_stats/voiting_sys_coverage.jpg}}
	\caption{\label{fig:coverage}
		Voting System Tests coverage
	}
\end{figure}
\begin{figure}[ht]
	\fbox{\includegraphics[width=\textwidth]{res/voting_sys_stats/voting_sys_tests_stat.jpg}}
	\caption{\label{fig:test_stat}
		Test Info
	}
\end{figure}
