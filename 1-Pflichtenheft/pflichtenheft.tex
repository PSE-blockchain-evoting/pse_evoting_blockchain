...
Bei dem Verbindungsaufbau eines \gls{Klient}{Klienten} zu dem \gls{Netzwerk} verbindet sich dieser mit dem \gls{Peer} der die kleinste \gls{Latenz} besitzt.
...
Der \gls{Klient} verbindet sich automatisch mit einem \gls{Peer} in dem \gls{Netzwerk}. Dabei beachtet der \gls{Klient} die \glslink{Latenz}{Latenzen} aller \glslink{Peer}{Peers} und verbindet sich schließlich mit dem \gls{Peer} mit der kleinsten \gls{Latenz}.
