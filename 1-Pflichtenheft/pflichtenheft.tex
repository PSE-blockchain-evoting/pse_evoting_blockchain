...
\criterium{Teilnahme an der Wahl}{crt:vote}
Ein \gls{Waehler} hat in seiner \gls{Benutzeroberflaeche} die Möglichkeit einen oder mehrere Kandidaten auszuwählen.
Beim Bestätigen seiner Auswahl wird diese an das Netzwerk übermittelt.
