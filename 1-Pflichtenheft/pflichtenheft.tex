...
Wahlen können mit dem \gls{Auszaehlungsverfahren} der \gls{Absolute Mehrheitswahl}{Absolute Me} ausgewertet werden. Die \gls{Absolute Mehrheitswahl} ist dementsprechend eine Option die dem \gls{Wahlleiter} zur Verfügung gestellt wird.
