...
Der \gls{Klient} verbindet sich automatisch mit einem \gls{Peer} im \gls{Netzwerk}. Dabei beachtet die \glslink{Latenz}{Latenzen} aller \glslink{Peer}{Peers} und wählt den mit der kleinsten \gls{Latenz} aus.
