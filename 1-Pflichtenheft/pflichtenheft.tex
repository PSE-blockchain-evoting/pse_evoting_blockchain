...
Beim Verbindungsaufbau eines \gls{Klient}{Klienten} zum \gls{Netzwerk} verbindet sich dieser mit dem \gls{Peer} der die kleinste \gls{Latenz} besitzt.
...
Der \gls{Klient} verbindet sich automatisch mit einem \gls{Peer} im \gls{Netzwerk}. Dabei beachtet der \gls{Klient} die \glslink{Latenz}{Latenzen} aller \glslink{Peer}{Peers} und verbindet sich schließlich mit dem \gls{Peer} mit der kleinsten \gls{Latenz}.
