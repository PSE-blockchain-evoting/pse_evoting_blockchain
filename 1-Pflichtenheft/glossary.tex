...
Eine Methode um valide Transaktionen in einer \gls{Blockchain} zu verifizieren. Beim Consensus-Verfahren entscheided jeder \gls{Peer} ob eine Transaktion gültig ist. Wenn genug \gls{Peers} eine Transaktion akzeptieren wird diese Transaktion in den \gls{Ledger} geschrieben.
}}
