...
\newglossaryentry{Stimme}{name={Stimme},description={
	Eine Zähleinheit, die im \gls{Auszählungsverfahren} zur Ermittlung des Wahlergebnisses benutzt wird.
}}
...
\begin{enumerate}
	\item Jeder Wähler kann jedem Kandidaten einen Wert von 1 bis n zuweisen. Werte düfen nicht mehrfach vergeben werden. Kandidaten können nicht bewertet werden.
	\item Bei der Auszählung wird bestimmt welcher Kandidat die wenigsten Stimmen mit Wert 1 bekommen hat. Dieser Kandidat wird dann aus allen Listen entfernt. Die Werte der Kandidaten auf den nachfolgenden Plätzen werden jeweils um 1 erhöht.
